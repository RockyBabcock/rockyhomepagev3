        ...
        <div className="relative z-10 flex flex-col h-full flex-1">
          <div className="mb-6">
            ...
            <p className="font-body text-[var(--museum-text-muted)] text-sm">
              Interface experiments for AI-native workflows, prompt systems,
              agents, and creative tools. Some experiments are prototypes or
              interface concepts. The goal is to document how AI changes the way
              software feels, not to pretend every idea is already a finished
              product.
            </p>
          </div>
          ...
          <div className="space-y-5 flex-1 mb-8 pt-4 border-t border-[var(--museum-border-strong)]">
            <div>
              ...
              <p className="text-sm text-[var(--museum-text-muted)] leading-relaxed bg-[var(--museum-bg)] p-3 rounded-lg border border-[var(--museum-border)]">
                An interface concept for experimenting with AI-assisted
                workflows.
              </p>
            </div>
            <div>
              ...
              <p className="text-sm text-[var(--museum-text-muted)] leading-relaxed bg-[var(--museum-bg)] p-3 rounded-lg border border-[var(--museum-border)]">
                AI tools need visible state, clear boundaries, and strong
            ...
            <div>
              ...
              <div className="text-sm text-[var(--museum-text-muted)] leading-relaxed bg-[var(--museum-bg)] p-3 rounded-lg border border-[var(--museum-border)] flex items-start gap-2">
                <AlertCircle
                  size={14}
                  className="mt-0.5 text-[var(--museum-accent)]/70 flex-shrink-0"
                />
                <span>
                  Connect the interface to real API flows and add saved
                  experiment logs.
                </span>
              </div>
            </div>
