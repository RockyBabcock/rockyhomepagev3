...
export const Web3VaultModule = () => {
  return (
    <div id="Web3Vault" className="h-full flex flex-col">
          ...
          <div className="flex justify-between items-start mb-6 gap-4">
            <div className="flex-1">
              ...
              <p className="font-body text-[var(--museum-text-muted)] text-sm max-w-[280px]">
                A learning archive for wallet UX, ownership models,
                decentralized interfaces, and on-chain identity patterns. This
                vault records exploration rather than mastery. The goal is to
                understand how Web3 interfaces can become clearer, safer, and
                more human.
              </p>
            </div>
