        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-8 items-stretch relative">
          ...
          <div className="lg:col-span-2 forge-domain-rail flex flex-row lg:flex-col gap-1.5 font-mono overflow-x-auto hide-scrollbar pb-2 lg:pb-0 px-1">
            ...
            {domains.map((domain, index) => {
              const isActive =
                selectedDomain === domain.id && !searchQuery.trim();
            ...
            <>
              ...
              <div className="lg:col-span-6 flex flex-col gap-6 w-full max-w-full">
                <div className="forge-reactor-panel p-6 md:p-8 flex flex-col relative overflow-hidden w-full">
                  ...
                  {/* RELATED STACK NODES */}
                  {selectedTech.relatedTools &&
                    selectedTech.relatedTools.length > 0 && (
                      <div className="mt-auto relative z-10 pt-6 border-t border-white/10">
                        ...
                        <div className="relative flex flex-col md:flex-row items-start md:items-center gap-6 w-full">
                          ...
                          <div className="flex flex-col md:flex-row gap-3 md:gap-4 flex-1 md:pl-8 relative z-10 flex-wrap">
                            {selectedTech.relatedTools.map((t, idx) => (
                              <div
                                key={t}
