...
export function ProfileModule() {
  ...
  return (
    <div
      className="flex flex-col relative z-10 w-full pt-20 lg:pt-32 pb-12 overflow-hidden"
      id="entrance"
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(var(--museum-ink) 1px, transparent 1px), linear-gradient(90deg, var(--museum-ink) 1px, transparent 1px)",
      ...
      <section className="mx-auto w-full max-w-[1440px] px-4 md:px-8 xl:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 mb-16">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            >
              <p>
                <strong className="text-[var(--museum-ink)] font-bold">
                  This is a Personal Digital Museum.
                </strong>{" "}
                It is not a standard portfolio, but a spatial hub bridging
                creative web design, AI interfaces, robust component
                architectures, and a personal catalog of ideas.
              </p>
              <p>
                Every wing of this site serves a purpose: proving technical
                stack viability, documenting case studies, exploring
                experimental systems, and logging the journey.
              </p>
            </motion.div>
                ...
                <div className="border-b border-white/10 pb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <span
                        key={tag}
                        className="px-2 py-1 bg-white/5 border border-white/10 rounded text-[11px] font-bold text-white hover:bg-white/10 transition-colors"
                      >
                        {tag}
                      </span>
                    ))}
          ...
          <div className="w-full overflow-x-auto hide-scrollbar px-4">
            <div className="flex min-w-max items-center justify-between gap-6 px-4">
              {visitorRouteElements.map((route, i) => (
                <div
                  key={route.id}
                  className="flex items-center gap-6 group/nav"
                >
                  <button
                  ...
                  >
                    <span
                      className="font-mono text-[10px] font-bold flex items-center gap-2 mb-1"
        ...
        <div className="flex justify-center mt-12 animate-bounce">
          <button
            ...
            onClick={() => scrollToElement("projects")}
            className="p-3 rounded-full bg-white/50 border border-[var(--border)] text-[var(--ink-muted)] hover:text-[var(--museum-ink)] transition-colors outline-none focus-visible:ring-2"
          >
