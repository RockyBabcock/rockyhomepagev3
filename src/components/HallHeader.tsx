  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-3 font-body text-xs font-bold uppercase tracking-widest text-[var(--museum-text-muted)] mb-4">
          ...
          <span
            className={cn(
              ...
              status === "Active" || status === "ACTIVE"
                ? "bg-[var(--color-rainbow-green)]/10 text-[var(--color-rainbow-green)]"
                : status === "Experimental" || status === "EXPERIMENTAL"
                  ? "bg-[var(--color-rainbow-cyan)]/10 text-[var(--color-rainbow-cyan)]"
        ...
        {category && (
          <span className="text-[var(--color-rainbow-purple)] font-black tracking-[0.2em]">
            {category}
          </span>
        )}
      </div>
      ...
      <h2
        id={id}
        className="text-4xl md:text-5xl lg:text-6xl font-headline font-bold tracking-tight text-[var(--museum-text)] mb-4 leading-none"
      >
        {title}
      </h2>
